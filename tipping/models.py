...
class AFLFixture(models.Model):
    ...
    hbehinds = models.IntegerField(default=0, null=True, blank=True)
    ...
    hgoals = models.IntegerField(default=0, null=True, blank=True)
    localtime = models.DateTimeField(null=True, blank=True)
    venue = models.CharField(max_length=100, null=True, default='')
    ascore = models.IntegerField(default=0, null=True, blank=True)
    ...
    agoals = models.IntegerField(default=0, null=True, blank=True)
    ...
    abehinds = models.IntegerField(default=0, null=True, blank=True)
    updated = models.DateTimeField(null=True, blank=True)
    hscore = models.IntegerField(default=0, null=True, blank=True)
